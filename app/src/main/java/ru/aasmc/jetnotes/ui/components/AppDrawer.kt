...
import ru.aasmc.jetnotes.theme.JetNotesThemeSettings
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(
            ...
            onClick = {
                JetNotesRouter.navigateNo(Screen.Trash)
                closeDrawerAction()
            }
        )
        LightDarkThemeItem()
...
private fun ScreenNavigationButton(
    ...
    // define alphas for the image for two different states of the button:
